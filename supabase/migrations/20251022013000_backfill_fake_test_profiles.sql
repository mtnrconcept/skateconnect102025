/*
  # Ensure Fake Test Profiles Exist

  ## Summary
  - Ensures extended profile columns exist before seeding QA demo accounts
  - Upserts the additional fake community profiles with rich metadata
*/
